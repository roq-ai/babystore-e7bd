  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to babyStore, your comprehensive ERP solution, streamlining pos, purchasing, billing, and inventory for a seamless store management experience."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1511733897353-5b04f82435a8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxiYWJ5JTIwc3RvcmV8ZW58MHx8fHwxNjk1MzE4ODA1fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@pepperguy184?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Jomjakkapat Parrueng`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to babyStore, your comprehensive ERP solution, streamlining pos, purchasing, billing, and inventory for a seamless store management experience.`}
            </Text>
            <Box
