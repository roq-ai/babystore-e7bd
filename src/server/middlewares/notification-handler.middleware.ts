...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order_placed.create': { roles: ['owner', 'store-manager'], key: 'order_id', tenantPath: [], userPath: [] },
  'inventory_updated.update': { roles: ['owner', 'store-manager'], key: 'inventory_id', tenantPath: [], userPath: [] },
  'feedback_given.create': { roles: ['owner', 'store-manager'], key: 'feedback_id', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['owner'];
const customerRoles: string[] = ['customer'];
const tenantRoles: string[] = ['owner', 'store-manager'];
